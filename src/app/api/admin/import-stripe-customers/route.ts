 ...
 *
 * GET ?account=SU|IQ|AURA|AURAUP&limit=50 → preview list of active subs and customer emails
 * POST body { account: 'SU'|'IQ'|'AURA'|'AURAUP', mode: 'import'|'preview', defaultPlanKey?: string }
