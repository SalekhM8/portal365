 ...
 *
 * GET ?account=<StripeAccountKey>&limit=50 → preview list of active subs and customer emails
 * POST body { account: StripeAccountKey, mode: 'import'|'preview', defaultPlanKey?: string }
